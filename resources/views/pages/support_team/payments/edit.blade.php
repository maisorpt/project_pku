...
@section('page_title', 'Sunting Pembayaran')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Kelola Pembayaran</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('payments.update', $payment->id) }}">
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">Jumlah (Rp) </label>
                            <div class="col-lg-9">
