...
class StudentRepo
{
    ...
    {
        return SalaryType::orderBy('id', 'asc')->get();
    }
    ...
    {
        return ParentRecord::orderBy('id', 'asc')->get();
    }

    public function getParentById($id)
    {
        return ParentRecord::where('id', $id)->get();
    }

    public function getLatestParentId()
    {
        return ParentRecord::max('id');
    }

    public function createParent($data)
    {
        return ParentRecord::create($data);
    }

    public function updateParentRecord($id, array $data)
    {
        return ParentRecord::find($id)->update($data);
    }
