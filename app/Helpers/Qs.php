...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'BQ';
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        $data = ['name', 'dob', 'gender', 'pob', 'address', 'prov_id', 'city_id', 'dis_id', 'subdis_id'];
    ...
    public static function getParentData($remove = [])
    {
        $data = ['father_name', 'mother_name', 'father_job', 'mother_job', 'father_phone', 'mother_phone', 'father_salary', 'mother_salary',];
